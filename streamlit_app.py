...
my_map = folium.Map(location=[52, 13], zoom_start=3.71)
...
cities_coords = {
                 ("Paris", "France"): [48.8647060137432, 2.344973305029235],
                 ("Nice", "France"): [43.704166549151005, 7.223284286319558],
                 ("Helsinki", "Finland"): [60.18710876379913, 24.939008469587762],
                 ("Copenhagen", "Denmark"): [55.67686170967649, 12.571849707145057]}
